({
    initCSallRow : function(component, event, helper) {
        ...
        if (component.get("v.startDate") != null) {
            ...
            console.log('capacityScheduleAllRowCntrl.initCSallRow * start date already exists, here is the starting Monday: ' + fDate);
        } else {
            ...
            console.log('capacityScheduleAllRowCntrl.initCSallRow * starting Monday: ' + fDate);
        }
    ...
    changeDate : function (component, event, helper) {
        ...
        if (startDate.length === 10 && source != undefined) {
            ...
            console.log('capacityScheduleAllRowCntrl * changeDate: cmp was refreshed or wrong date format -> ' + startDate);
        }
