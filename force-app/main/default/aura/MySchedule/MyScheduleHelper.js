({
    ...
    init : function(component, event) {
        ...
        console.log('initializing CapacityScheduleAllRowHlpr...from ' + event.getSource() + ' - startDate: ' + startDate);
        ...
        action.setCallback(this, function(response) {
            ...
            if (component.isValid() && state === "SUCCESS") {
                console.log('CapacityScheduleAllRow query state: ' + state);
                var sArray = [],
                	schedules = [],
                	schAry = [],
                ...
                console.log("CapacityScheduleAllRowHlpr * Failed with state: " + state);
            }
            //else if (cmp.isValid() && state === "ERROR") {
                ...
                if (errors) {
                    if (errors[0] && errors[0].message) {
                        console.log("CapacityScheduleAllRowHlpr * Error message: " + 
                                 errors[0].message);
                    }
                } else {
                    console.log("CapacityScheduleAllRowHlpr * Unknown error");
                }
            }
        });
