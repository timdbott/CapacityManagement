({
    ...
    teamChanged : function (component, event, helper) {

        console.log('CapacitySchedules started teamChanged');
        console.log("teamChanged.newTeam: " + component.get("v.caseTeam"));

        helper.filterSrnUsers(component, event);

        //var newTeam = component.get("v.caseTeam");
        // call the method in CapacitySchedulesTeamps.cmp
        //var childCmp = component.find("cpctyTeams");
        //var auraMethodResult = childCmp.changedTeam(newTeam);
        //console.log("teamChanged.auraMethodResult: " + auraMethodResult);
    }
})