({
    doInit : function(component, event, helper) {
        ...
        if (startDate === null) {
            startDate = new Date();
            //console.log('CapacityScheduleAdminRowCntlr * startDate: ' + startDate);
        }
        ...
        //console.log('CapacityScheduleAdminRowCntlr * daysToDisplay: ' + daysToDisplay);
        ...
        var action = component.get("c.getAdminSchedules");
        ...
        action.setCallback(this, function(response) {
            ...
            if (component.isValid() && state === "SUCCESS") {
                //console.log('CapacityScheduleAdminRowCntlr query state: ' + state);
